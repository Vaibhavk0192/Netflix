        ...
        <div className=" w-[43%] m-auto flex flex-col">
          ...
          <div className="flex mt-6">
            ...
            <div className=" ml-6 flex flex-col ">
              ...
              <div className="mt-1">
                <select name="language" id="language" className="outline-none px-3 py-1 bg-black text-white border text-sm border-white hover:bg-[rgb(45,45,45)]">
              ...
              <span className="text-white mt-4 text-sm font-normal">Your handle is a unique name that'll be used for playing with other Netflix members across all Netflix games.</span>
              <input
              ...
              />
              <hr className="border-1 h-px bg-[#232323] mt-12 border-transparent"/>
              <Headings heading="Game Handle"/>
              <span className="text-white text-sm mt-3 bg-[rgb(45,45,45)] py-2 px-4 w-max font-semibold">All Maturity Ratings</span>
              <span className="text-white text-sm mt-3 mb-8">Show title of <span className="font-semibold">all maturity ratings </span>for this profile</span>
          ...
          <div className="flex mt-8 items-center gap-4 mb-10">
            <button className="w-max px-6 py-1 bg-white hover:bg-[#e50914] hover:text-white font-semibold text-md">Save</button>
